...
class DataTransformation:
    ...
    def get_data_transformer_object(self)->Pipeline:
        """
        It Initiated a KNNImputer object with  the parameters specified in training_pipline.py file and returns
        a pipeline object with the KNNImputer object ass the first step
        ...
        try:
            ...
            logging.info(f"initialise KNNcomputer with {DATA_TRANSFORMER_IMPUTER_PARAMS}")
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("Entered Initiated data_transformation_method of Data Transformation class")
